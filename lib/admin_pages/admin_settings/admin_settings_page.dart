...
import 'package:namer_app/admin_pages/admin_settings/admin_account_info_page.dart';
import 'package:namer_app/admin_pages/admin_settings/admin_contact_page.dart';
import 'package:namer_app/admin_pages/admin_settings/admin_help_center_page.dart';
import 'package:namer_app/admin_pages/admin_settings/admin_more_info_page.dart';
                  ...
                  child: ListTile(
                    ...
                    onTap: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AdminAccountInfoPage(),
                        ),
                      );
                ...
                _buildOption(
                  ...
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const AdminAccountInfoPage(),
                      ),
                    );
                  },
                ),
                ...
                _buildOption(
                  ...
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const AdminHelpCenterPage(),
                      ),
                    );
                ...
                _buildOption(
                  ...
                  onTap: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const AdminMoreInfoPage(),
                      ),
                    );
                    // Implementar navegación a centro de ayuda
                  },
